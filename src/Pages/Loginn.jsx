  ...
  return (
    <div className="login-page container card">
      ...
      <form onSubmit={handleSubmit} className="login-form">
        ...
        />
        <div className="password-wrapper" style={{display:'flex', gap:8, alignItems:'center'}}>
          <input
            className="input"
            style={{flex:1}}
            ...
            onChange={handleChange}
          />
          <button type="button" onClick={() => setShowPassword(!showPassword)} className="btn secondary">
